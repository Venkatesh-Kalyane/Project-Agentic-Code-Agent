# 🛠️ Agentic Code Agent

**Agentic Code Agent** is an AI-powered coding assistant built with [LangGraph](https://github.com/langchain-ai/langgraph).  
...
<div style="text-align: center;">
    <img src="resources/Agentic_Code_Agent.png" alt="Agentic Code Agent Architecture" width="90%"/>
</div>
...
- Create a virtual environment using: `uv venv` and activate it using `.venv\Scripts\activate`
